...
const tools = [
  ...
  { title: 'Music FX', description: 'Análise profunda de áudio', url: '/music-dna', icon: Music, color: 'bg-indigo-500/10 text-indigo-600' },
  ...
  { title: 'Gerador de Vídeos', description: 'Sequências de imagens', url: '/video-frames', icon: Film, color: 'bg-fuchsia-500/10 text-fuchsia-600' },
];
