...
export default function MusicDnaPage() {
  ...
  const handleDownloadMp3 = () => {
    ...
    const handleDownloadMp3 = () => {
      ...
      let downloadUrl = url;
      // Robust YouTube detection (including music.youtube, m.youtube, youtu.be)
      ...
      if (isYouTube) {
        ...
        // yout.com conversion: just remove 'ube' or replace domain
        // Pattern: https://www.yout.com/watch?v=...
        downloadUrl = url.replace(/youtube\.com|youtu\.be/, "yout.com");
      } else {
        toast({
          ...
          <AnimatePresence mode="wait">
            {scanning ? (
              ...
              >
                ...
                <p className="text-muted-foreground animate-pulse">Desconstruindo estrutura harmônica e metadados...</p>
              </motion.div>
            ) : result ? (
              <motion.div
                key="result"
                    ...
                    <div className="flex flex-col md:flex-row gap-8 relative z-10">
                      ...
                      <div className="flex-1 flex flex-col justify-between py-2">
                        <div>
                          ...
                          <h2 className="text-4xl md:text-5xl font-black text-foreground mb-2 leading-tight">
                            {result.title}
                          </h2>
                          <p className="text-2xl text-muted-foreground font-medium flex items-center gap-2">
                            {result.artist}
                            {result.band && <span className="text-muted-foreground/60 text-lg">· {result.band}</span>}
                          </p>
                        </div>
                      ...
                      {result.lyrics.includes("Genius") && (
                        <div className="mt-8 pt-8 border-t border-border">
                          <a
                            ...
                            className="inline-flex items-center gap-2 text-emerald-600 dark:text-emerald-400 hover:text-emerald-700 dark:hover:text-emerald-300 font-bold group"
                          >
