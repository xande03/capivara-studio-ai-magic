        ...
        <div className="max-w-6xl mx-auto space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
            <header className="space-y-4">
                <div className="flex items-center gap-4">
                    <div className="w-14 h-14 rounded-2xl overflow-hidden shadow-lg shadow-red-500/20 border border-border">
                        <img src="/logo.png" alt="Capivara Stúdio" className="w-full h-full object-cover" />
                    </div>
                    <div>
                        <h1 className="text-3xl font-black tracking-tight red-text">QR Code Magic</h1>
            ...
            <div className="grid lg:grid-cols-2 gap-8 items-start pb-12">
                ...
                <div className="space-y-6">
                        ...
                        <CardContent className="space-y-6">
                            <Tabs value={category} onValueChange={handleCategoryChange} className="w-full">
                                <TabsList className="grid grid-cols-6 w-full bg-secondary p-1 rounded-xl">
                                    <TabsTrigger value="link" className="data-[state=active]:bg-red-500 data-[state=active]:text-white rounded-lg transition-all"><LinkIcon className="w-4 h-4" /></TabsTrigger>
                                    <TabsTrigger value="pdf" className="data-[state=active]:bg-red-500 data-[state=active]:text-white rounded-lg transition-all"><FileText className="w-4 h-4" /></TabsTrigger>
                                    <TabsTrigger value="music" className="data-[state=active]:bg-red-500 data-[state=active]:text-white rounded-lg transition-all"><Music className="w-4 h-4" /></TabsTrigger>
                                    <TabsTrigger value="image" className="data-[state=active]:bg-red-500 data-[state=active]:text-white rounded-lg transition-all"><ImageIcon className="w-4 h-4" /></TabsTrigger>
                                    <TabsTrigger value="file" className="data-[state=active]:bg-red-500 data-[state=active]:text-white rounded-lg transition-all"><File className="w-4 h-4" /></TabsTrigger>
                                    <TabsTrigger value="text" className="data-[state=active]:bg-red-500 data-[state=active]:text-white rounded-lg transition-all"><Type className="w-4 h-4" /></TabsTrigger>
                                </TabsList>
                                ...
                                <div className="mt-8 space-y-6">
                                    {(category === "link" || category === "text") ? (
                                        <div className="space-y-3">
                                            ...
                                            <Input
                                                ...
                                                className="bg-secondary/50 border-border focus:border-red-500/50 h-12 transition-all placeholder:text-muted-foreground/50"
                                            />
                                        </div>
                                    ) : (
                                        <div className="space-y-3">
                                            ...
                                            <label
                                                className="flex flex-col items-center justify-center w-full h-40 border-2 border-dashed border-border rounded-2xl cursor-pointer hover:bg-red-500/5 hover:border-red-500/40 transition-all group overflow-hidden relative bg-secondary/30"
                                            >
                                                <div className="flex flex-col items-center justify-center pt-5 pb-6 z-10">
                                                    {file ? (
                                                        <CheckCircle2 className="w-10 h-10 text-red-500 mb-3 animate-bounce" />
                                                    ) : (
                                                        <Upload className="w-10 h-10 text-muted-foreground group-hover:text-red-500 transition-colors mb-3" />
                                                    )}
                                    ...
                                    <div className="space-y-3 p-4 rounded-2xl bg-secondary/30 border border-border">
                                        ...
                                        <Input
                                            ...
                                            className="bg-secondary/50 border-border focus:border-red-500/20 italic text-xs h-10 placeholder:text-muted-foreground/40"
                                        />
                                    </div>
                                </div>
                            </Tabs>
                    ...
                    <Card className="bg-red-500/5 border-red-500/10 p-4">
                        <div className="flex items-start gap-3">
                            ...
                            <div>
                                <p className="text-xs font-bold red-text uppercase tracking-widest">Garantia Studio Pro</p>
                ...
                <div className="lg:sticky lg:top-8">
                    <Card className="glass-card p-10 flex flex-col items-center justify-center min-h-[500px] relative overflow-hidden rounded-3xl shadow-2xl">
                        ...
                        <div className="absolute top-0 right-0 w-64 h-64 bg-red-500/5 blur-[100px] rounded-full animate-pulse" />
                        <div className="absolute bottom-0 left-0 w-64 h-64 bg-red-500/5 blur-[100px] rounded-full delay-700 animate-pulse" />
                        ...
                        {qrValue ? (
                            <div className="space-y-10 flex flex-col items-center w-full animate-in zoom-in-95 duration-500">
                                ...
                                >
                                    <QRCodeSVG
                                        ...
                                        includeMargin={false}
                                    />
                                    <div className="absolute inset-0 border-4 border-red-500/10 rounded-[40px] group-hover:border-red-500/30 transition-all pointer-events-none" />
                                </div>

                                <div className="text-center space-y-3">
                                    <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-red-500/10 border border-red-500/20 text-[10px] font-bold red-text uppercase tracking-widest">
                            ...
                            <div className="text-center space-y-8 flex flex-col items-center">
                                <div className="w-56 h-56 bg-secondary rounded-[40px] flex items-center justify-center border border-border relative group">
                                    <div className="absolute inset-0 bg-red-500/5 blur-xl group-hover:bg-red-500/10 transition-all rounded-full" />
                                    <QrCode className="w-20 h-20 text-muted-foreground/20 group-hover:text-red-500/20 transition-all" />
                                </div>
                                <div className="space-y-3">
